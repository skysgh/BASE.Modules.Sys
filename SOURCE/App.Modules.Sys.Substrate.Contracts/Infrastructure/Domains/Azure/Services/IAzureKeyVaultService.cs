using App.Modules.Sys.Infrastructure.Domains.Azure.Models.Implementations.Base;
...
namespace App.Modules.Sys.Infrastructure.Domains.Azure.Services
{
    ...
    public interface IAzureKeyVaultService
    {
        ...
        /// <param name="vaultUrl"></param>
        /// <returns></returns>
        Task<AppSecretBundle> SetSecretAsync(string secretKey, string secret, string vaultUrl);
