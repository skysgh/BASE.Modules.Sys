...
namespace App.Base.Infrastructure.Configuration
{
    ...
    public class AppConfigurationObject : IConfigurationObject
    {
        ...
        /// </para>
        /// </summary>
        public static AppConfigurationObject Instance
        { get; private set; }
            = new AppConfigurationObject();
    ...
    /// <para>
    /// A sub object of 
    /// <see cref="AppConfigurationObject"/>
    /// </para>
    /// </summary>
    [Alias(Name)]
    public class Hosting : IConfigurationObject
    {
        ...
        /// Configuration Section Path.
        /// </summary>
        public const string Path = AppConfigurationObject.Path + Name;
    ...
    /// <para>
    /// A subobject of <see cref="AppConfigurationObject"/>
    /// </para>
    /// </summary>
    [Alias(Name)]
