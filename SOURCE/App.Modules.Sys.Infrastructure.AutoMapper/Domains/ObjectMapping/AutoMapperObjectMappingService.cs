...
namespace App.Modules.Sys.Infrastructure.Domains.ObjectMapping
{
    /// <summary>
    ...
    public class AutoMapperObjectMappingService : IObjectMappingService
    {
        ...
        public IQueryable<TTarget> ProjectTo<TSource, TTarget>(IQueryable<TSource> source)
            ...
            where TTarget : class
        {
            // AutoMapper's ProjectTo - translates to efficient SQL SELECT
            return source.ProjectTo<TTarget>(_configuration);
        }
