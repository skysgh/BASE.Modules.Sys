...
using App.Modules.Sys.Shared.Domains.Users;
using System;
using System.Collections.Generic;

namespace App.Modules.Sys.Domain.Domains.Identity
{
    /// <summary>
    ...
    public class User : IUser
    {
        ...
        /// </summary>
        public List<UserSystemPermissionRelationship> SystemPermissions { get; set; } = new();
